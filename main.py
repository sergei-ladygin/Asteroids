    ...
    while True:
        ...
        while run:
            ...
            """for one_asteroid in asteroids:
                for another_asteroid in asteroids:
                    if one_asteroid != another_asteroid and one_asteroid.collide(another_asteroid):
                            one_asteroid.kill()    # asteroids collapsed
                            another_asteroid.kill()
            """
